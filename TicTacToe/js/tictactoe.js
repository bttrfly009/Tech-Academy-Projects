...
if (activePlayer === 'X') {
//The activePlayer is equal to 'X', the x.png is placed in HTML.
select.style.backgroundImage = 'url("/images/x.png")';
//active player may only be 'X' or 'O' so, if not 'X' it must be '0'
} else {
//T£ activePlayer is equal to '0', the o.png is placed in HTML.
select.style.backgroundImage = 'url("/images/o.png")';
}
//squareNumber and activePlayer are concatenated together and added to array.
selectedSquares.push(squareNumber + activePlayer);

//Tais calls a function to check for any win conditions.
checkWinConditions();
...
while(!success){
//B random number between 0 and 8 is selected.
...
//drawWinLine function is called to draw la line if the condition is met.
...
function arrayIncludes(squareA, squareB, squareC) {
    ...
    //will be returned and the 'else if' condition executes the drawWinLine function.
    ...
    //End Y
     ...
     function animateLineDrawing() {
       ...
       //This method moves us to a starting point for our line.  
        c.moveTo(x1, y1)
        //This methos indicates the end point in our line.
        c.lineTo(x,y)
        //This method sets the width 
        lineWidth = 10;
        //Color
        strokeStyle = 'rgba(70, 255, 33, .8)';
        //This is what actually draws what was laid out above
        c.stroke();
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            //if we've reached our end points.
...
//This function resets the game in an event of a tie or a win.
function resetGame() {
